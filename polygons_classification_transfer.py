...
class PolygonsDataSetTransformed(td.Dataset):
    ...
    def __getitem__(self,idx):
        ...
        return (tv.transforms.PILToTensor()(img) if self.current_transform < 8 else img, sides)
...
class PolygonsNet(nn.Module):
    def __init__(self):
        ...
        self.model.fc = nn.Linear(self.model.fc.in_features, out_features= 4)
...
traindata = PolygonsDataSet(x_train, y_train)
